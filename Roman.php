...
// | Emeritus: Sterling Hughes <sterling@php.net>                         |
// +----------------------------------------------------------------------+
// $Id$
//
 ...
 * it supports lower case input and output and some furthers conversion
 * functions.
 *
 *
 * @access public
...
class Numbers_Roman
{
	...
	*                        lower cased numerals are converted into uppercase
	...
	*/
	...
	function toNumeral($num, $uppercase = true, $html = true)
	{
		...
		* was to add an overscore on the numerals. Because of the non ansi equivalent
		* if the html output option is true we will return the overline in the html code
		* if false we will return a _ to represent the overscore to convert from numeral to arabic
		...
		* We initially set the replace to AFS which will be later replaced with the M
		*
